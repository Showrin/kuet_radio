...
<pre><code>npm i glob
</code></pre><pre><code class="lang-javascript">var glob = require(&quot;glob&quot;)
...
<h2 id="glob-hasmagic-pattern-options-">glob.hasMagic(pattern, [options])</h2>
...
options.</p>
<h2 id="glob-pattern-options-cb-">glob(pattern, [options], cb)</h2>
<ul>
...
<h2 id="glob-sync-pattern-options-">glob.sync(pattern, [options])</h2>
<ul>
<li><code>pattern</code> <code>{String}</code> Pattern to be matched</li>
<li><code>options</code> <code>{Object}</code></li>
...
<h2 id="class-glob-glob">Class: glob.Glob</h2>
<p>Create a Glob object by instantiating the <code>glob.Glob</code> class.</p>
<pre><code class="lang-javascript">var Glob = require(&quot;glob&quot;).Glob
var mg = new Glob(pattern, options, cb)
</code></pre>
<p>It&#39;s an EventEmitter, and starts walking the filesystem to find matches
immediately.</p>
<h3 id="new-glob-glob-pattern-options-cb-">new glob.Glob(pattern, [options], [cb])</h3>
<ul>
...
npm run prof
</code></pre><p><img src="oh-my-glob.gif" alt=""></p>
