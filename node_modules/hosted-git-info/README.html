<html>
      ...
      <body>
        <h1 id="hosted-git-info">hosted-git-info</h1>
...
<pre><code class="lang-javascript">var hostedGitInfo = require(&quot;hosted-git-info&quot;)
...
strings (<a href="mailto:`git@github.com">`git@github.com</a>:npm/hosted-git-info<code>) and shortcuts (eg,</code>github:npm/hosted-git-info<code>).  Github specifically, is detected in the case
of a third, unprefixed, form:</code>npm/hosted-git-info`.</p>
...
<h3 id="var-info-hostedgitinfo-fromurl-gitspecifier-options-">var info = hostedGitInfo.fromUrl(gitSpecifier[, options])</h3>
<ul>
<li><em>gitSpecifer</em> is a URL of a git repository or a SCP-style specifier of one.</li>
<li><em>options</em> is an optional object. It can have the following properties:<ul>
...
<p>eg, <a href="mailto:`git@github.com">`git@github.com</a>:npm/hosted-git-info.git`</p>
<ul>
