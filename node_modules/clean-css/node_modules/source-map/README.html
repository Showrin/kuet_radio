...
<ul>
<li><p>Modern Browsers supporting ECMAScript 5 (either after the build, or with an
...
</code></pre><h2 id="building-from-source-for-everywhere-else-">Building from Source (for everywhere else)</h2>
...
<li><p><code>names</code>: An array of identifiers which can be referrenced by individual
mappings.</p>
</li>
...
<li><p><code>column</code>: The column number in the original source, or null or null if this
...
<p>In other words, if this method returns <code>true</code>, then <code>smc.sourceContentFor(s)</code>
will succeed for every source <code>s</code> in <code>smc.sources</code>.</p>
...
<pre><code class="lang-js">exports[&quot;test doing the foo bar&quot;] = function (assert, util) {
  ...
};
</code></pre>
