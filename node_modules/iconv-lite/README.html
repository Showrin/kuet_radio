<html>
      ...
      <body>
        <h2 id="pure-js-character-encoding-conversion-build-status">Pure JS character encoding conversion <a href="https://travis-ci.org/ashtuchkin/iconv-lite"><img src="https://travis-ci.org/ashtuchkin/iconv-lite.svg?branch=master" alt="Build Status"></a></h2>
<ul>
...
<pre><code class="lang-javascript">var iconv = require(&#39;iconv-lite&#39;);
...
<h3 id="streaming-api-node-v0-10-">Streaming API (Node v0.10+)</h3>
...
<h3 id="-deprecated-extend-node-js-own-encodings">[Deprecated] Extend Node.js own encodings</h3>
<blockquote>
...
<pre><code class="lang-javascript">// After this call all Node basic primitives will understand iconv-lite encodings.
...
<h2 id="encoding-decoding-speed">Encoding/decoding speed</h2>
...
</code></pre><h2 id="bom-handling">BOM handling</h2>
<ul>
...
<h2 id="utf-16-encodings">UTF-16 Encodings</h2>
...
<p>When decoding, be sure to supply a Buffer to decode() method, otherwise <a href="https://github.com/ashtuchkin/iconv-lite/wiki/Use-Buffers-when-decoding">bad things usually happen</a>.<br>Untranslatable characters are set to � or ?. No transliteration is currently supported.<br>Node versions 0.10.31 and 0.11.13 are buggy, don&#39;t use them (see #65, #77).  </p>
<h2 id="testing">Testing</h2>
<pre><code class="lang-bash">$ git clone git@github.com:ashtuchkin/iconv-lite.git
$ cd iconv-lite
$ npm install
$ npm test
