...
<pre><code class="lang-javascript">var valid = require(&#39;validate-npm-package-license&#39;);
</code></pre>
...
<pre><code class="lang-javascript">assert.deepEqual(
  valid(&#39;Apache 2.0&#39;),
  {
...
<pre><code class="lang-javascript">// Simple SPDX license expression for dual licensing
assert.deepEqual(
...
<pre><code class="lang-javascript">var warningAboutLicenseRef = {
  validForOldPackages: false,
  validForNewPackages: false,
  spdx: true,
  warnings: [
...
<pre><code class="lang-javascript">var unlicensed = {
  validForNewPackages: true,
  validForOldPackages: true,
  unlicensed: true
};
