...
<pre><code class="lang-javascript">var Minimatch = require(&quot;minimatch&quot;).Minimatch
...
<pre><code>  [ [ a, d ]
  , [ b, c, d ] ]
</code></pre><p>  If a portion of the pattern doesn&#39;t have any &quot;magic&quot; in it
...
<h3 id="minimatch-path-pattern-options-">minimatch(path, pattern, options)</h3>
<p>Main export.  Tests a path against the pattern using the options.</p>
<pre><code class="lang-javascript">var isJS = minimatch(file, &quot;*.js&quot;, { matchBase: true })
</code></pre>
<h3 id="minimatch-filter-pattern-options-">minimatch.filter(pattern, options)</h3>
<p>Returns a function that tests its
supplied argument, suitable for use with <code>Array.filter</code>.  Example:</p>
<pre><code class="lang-javascript">var javascripts = fileList.filter(minimatch.filter(&quot;*.js&quot;, {matchBase: true}))
</code></pre>
<h3 id="minimatch-match-list-pattern-options-">minimatch.match(list, pattern, options)</h3>
<p>Match against the list of
files, in the style of fnmatch or glob.  If nothing is matched, and
options.nonull is set, then return a list containing the pattern itself.</p>
<pre><code class="lang-javascript">var javascripts = minimatch.match(fileList, &quot;*.js&quot;, {matchBase: true}))
</code></pre>
<h3 id="minimatch-makere-pattern-options-">minimatch.makeRe(pattern, options)</h3>
...
<h2 id="comparisons-to-other-fnmatch-glob-implementations">Comparisons to other fnmatch/glob implementations</h2>
