...
</code></pre><h2 id="use-on-the-web">Use on the Web</h2>
...
<li><a href="#generating-a-source-map">Generating a source map</a><ul>
...
<li><a href="#sourcemapconsumer">SourceMapConsumer</a><ul>
...
<li><a href="#sourcemapgenerator">SourceMapGenerator</a><ul>
...
<li>[SourceMapGenerator.prototype.applySourceMap(sourceMapConsumer<a href="#sourcemapgeneratorprototypeapplysourcemapsourcemapconsumer-sourcefile-sourcemappath">, sourceFile[, sourceMapPath]])</a></li>
<li><a href="#sourcemapgeneratorprototypetostring">SourceMapGenerator.prototype.toString()</a></li>
</ul>
</li>
<li><a href="#sourcenode">SourceNode</a><ul>
<li>[new SourceNode([line, column, source<a href="#new-sourcenodeline-column-source-chunk-name">, chunk[, name]]])</a></li>
...
<pre><code class="lang-js">var rawSourceMap = {
  version: 3,
  file: &#39;min.js&#39;,
  names: [&#39;bar&#39;, &#39;baz&#39;, &#39;n&#39;],
...
<pre><code class="lang-js">function compile(ast) {
  switch (ast.type) {
...
<pre><code class="lang-js">var map = new SourceMapGenerator({
...
<pre><code class="lang-js">// Node.js
...
<h4 id="new-sourcemapconsumer-rawsourcemap-">new SourceMapConsumer(rawSourceMap)</h4>
...
<pre><code class="lang-js">var consumer = new sourceMap.SourceMapConsumer(rawSourceMapJsonData);
</code></pre>
...
<code>SourceMapConsumer.GREATEST_LOWER_BOUND</code>.</p>
</li>
</ul>
...
not available.  The line number is 1-based.</p>
</li>
<li><p><code>column</code>: The column number in the original source, or null if this
information is not available.  The column number is 0-based.</p>
</li>
<li><p><code>name</code>: The original identifier, or null if this information is not available.</p>
</li>
</ul>
<pre><code class="lang-js">consumer.originalPositionFor({ line: 2, column: 10 })
// { source: &#39;foo.coffee&#39;,
//   line: 2,
//   column: 2,
//   name: null }
...
<h4 id="sourcemapconsumer-prototype-generatedpositionfor-originalposition-">SourceMapConsumer.prototype.generatedPositionFor(originalPosition)</h4>
...
column number is 0-based.</p>
</li>
</ul>
<pre><code class="lang-js">consumer.generatedPositionFor({ source: &quot;example.js&quot;, line: 2, column: 10 })
// { line: 1,
//   column: 56 }
</code></pre>
<h4 id="sourcemapconsumer-prototype-allgeneratedpositionsfor-originalposition-">SourceMapConsumer.prototype.allGeneratedPositionsFor(originalPosition)</h4>
...
<pre><code class="lang-js">consumer.allGeneratedpositionsfor({ line: 2, source: &quot;foo.coffee&quot; })
// [ { line: 2,
//     column: 1 },
//   { line: 2,
//     column: 10 },
...
<h4 id="sourcemapconsumer-prototype-sourcecontentfor-source-returnnullonmissing-">SourceMapConsumer.prototype.sourceContentFor(source[, returnNullOnMissing])</h4>
...
instead.</p>
<pre><code class="lang-js">consumer.sources
// [ &quot;my-cool-lib.clj&quot; ]
...
<h4 id="sourcemapconsumer-prototype-eachmapping-callback-context-order-">SourceMapConsumer.prototype.eachMapping(callback, context, order)</h4>
...
<pre><code class="lang-js">consumer.eachMapping(function (m) { console.log(m); })
// ...
// { source: &#39;illmatic.js&#39;,
//   generatedLine: 1,
//   generatedColumn: 0,
...
<h4 id="new-sourcemapgenerator-startofsourcemap-">new SourceMapGenerator([startOfSourceMap])</h4>
...
running tests, if possible.</p>
</li>
</ul>
<pre><code class="lang-js">var generator = new sourceMap.SourceMapGenerator({
  file: &quot;my-generated-javascript-file.js&quot;,
  sourceRoot: &quot;http://example.com/app/js/&quot;
});
</code></pre>
<h4 id="sourcemapgenerator-fromsourcemap-sourcemapconsumer-">SourceMapGenerator.fromSourceMap(sourceMapConsumer)</h4>
...
<pre><code class="lang-js">var generator = sourceMap.SourceMapGenerator.fromSourceMap(consumer);
</code></pre>
...
<pre><code class="lang-js">generator.addMapping({
  source: &quot;module-one.scm&quot;,
  original: { line: 128, column: 0 },
  generated: { line: 3, column: 456 }
})
</code></pre>
<h4 id="sourcemapgenerator-prototype-setsourcecontent-sourcefile-sourcecontent-">SourceMapGenerator.prototype.setSourceContent(sourceFile, sourceContent)</h4>
...
<pre><code class="lang-js">generator.setSourceContent(&quot;module-one.scm&quot;,
                           fs.readFileSync(&quot;path/to/module-one.scm&quot;))
</code></pre>
<h4 id="sourcemapgenerator-prototype-applysourcemap-sourcemapconsumer-sourcefile-sourcemappath-">SourceMapGenerator.prototype.applySourceMap(sourceMapConsumer[, sourceFile[, sourceMapPath]])</h4>
...
<pre><code class="lang-js">generator.toString()
...
<h4 id="new-sourcenode-line-column-source-chunk-name-">new SourceNode([line, column, source[, chunk[, name]]])</h4>
<ul>
<li><p><code>line</code>: The original line number associated with this source node, or null if
it isn&#39;t associated with an original line.  The line number is 1-based.</p>
</li>
...
<pre><code class="lang-js">var node = new SourceNode(1, 2, &quot;a.cpp&quot;, [
  new SourceNode(3, 4, &quot;b.cpp&quot;, &quot;extern int status;\n&quot;),
  new SourceNode(5, 6, &quot;c.cpp&quot;, &quot;std::string* make_string(size_t n);\n&quot;),
  new SourceNode(7, 8, &quot;d.cpp&quot;, &quot;int main(int argc, char** argv) {}\n&quot;),
]);
</code></pre>
<h4 id="sourcenode-fromstringwithsourcemap-code-sourcemapconsumer-relativepath-">SourceNode.fromStringWithSourceMap(code, sourceMapConsumer[, relativePath])</h4>
...
<pre><code class="lang-js">var consumer = new SourceMapConsumer(fs.readFileSync(&quot;path/to/my-file.js.map&quot;, &quot;utf8&quot;));
...
<pre><code class="lang-js">node.add(&quot; + &quot;);
node.add(otherNode);
...
<pre><code class="lang-js">node.prepend(&quot;/** Build Id: f783haef86324gf **/\n\n&quot;);
</code></pre>
<h4 id="sourcenode-prototype-setsourcecontent-sourcefile-sourcecontent-">SourceNode.prototype.setSourceContent(sourceFile, sourceContent)</h4>
...
<pre><code class="lang-js">node.setSourceContent(&quot;module-one.scm&quot;,
                      fs.readFileSync(&quot;path/to/module-one.scm&quot;))
</code></pre>
...
<pre><code class="lang-js">var node = new SourceNode(1, 2, &quot;a.js&quot;, [
...
<h4 id="sourcenode-prototype-walksourcecontents-fn-">SourceNode.prototype.walkSourceContents(fn)</h4>
...
<pre><code class="lang-js">var a = new SourceNode(1, 2, &quot;a.js&quot;, &quot;generated from a&quot;);
...
<pre><code class="lang-js">var lhs = new SourceNode(1, 2, &quot;a.rs&quot;, &quot;my_copy&quot;);
...
<h4 id="sourcenode-prototype-replaceright-pattern-replacement-">SourceNode.prototype.replaceRight(pattern, replacement)</h4>
...
<pre><code class="lang-js">// Trim trailing white space.
node.replaceRight(/\s*$/, &quot;&quot;);
</code></pre>
