...
<pre><code class="lang-bash">npm install delayed-stream
</code></pre>
<h2 id="usage">Usage</h2>
<p>The following example shows how to write a http echo server that delays its
response by 1000 ms.</p>
<pre><code class="lang-javascript">var DelayedStream = require(&#39;delayed-stream&#39;);
...
<pre><code class="lang-javascript">var delayed = DelayedStream.create(req);
