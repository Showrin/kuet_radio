...
<pre><code class="lang-javascript">var JSONError = errorEx(&#39;JSONError&#39;, {fileName: errorEx.line(&#39;in %s&#39;)});
...
<pre><code class="lang-javascript">var JSONError = errorEx(&#39;JSONError&#39;, {fileName: errorEx.append(&#39;in %s&#39;)});
...
<h2 id="api">API</h2>
<h4 id="errorex-name-properties-"><code>errorEx([name], [properties])</code></h4>
...
looked up on the error message, and then passed to function values.<ul>
...
<h4 id="errorex-line-str-"><code>errorEx.line(str)</code></h4>
...
<ul>
<li><code>str</code>: The string to create<ul>
...
<h4 id="errorex-append-str-"><code>errorEx.append(str)</code></h4>
...
<ul>
<li><code>str</code>: The string to append<ul>
<li>Use the delimiter <code>%s</code> to specify where in the string the value should go</li>
</ul>
</li>
</ul>
