<html>
      ...
      <body>
        <h1 id="qs-sup-version-badge-sup-">qs <sup><a href="https://npmjs.org/package/qs"><img src="http://versionbadg.es/ljharb/qs.svg" alt="Version Badge"></a></sup></h1>
...
<pre><code class="lang-javascript">var qs = require(&#39;qs&#39;);
...
<pre><code class="lang-javascript">qs.parse(string, [options]);
</code></pre>
...
<pre><code class="lang-javascript">assert.deepEqual(qs.parse(&#39;foo[bar]=baz&#39;), {
    foo: {
        bar: &#39;baz&#39;
    }
});
...
<pre><code class="lang-javascript">var nullObject = qs.parse(&#39;a[hasOwnProperty]=b&#39;, { plainObjects: true });
...
<pre><code class="lang-javascript">var protoObject = qs.parse(&#39;a[hasOwnProperty]=b&#39;, { allowPrototypes: true });
assert.deepEqual(protoObject, { a: { hasOwnProperty: &#39;b&#39; } });
</code></pre>
<p>URI encoded strings work too:</p>
<pre><code class="lang-javascript">assert.deepEqual(qs.parse(&#39;a%5Bb%5D=c&#39;), {
    a: { b: &#39;c&#39; }
});
</code></pre>
<p>You can also nest your objects, like <code>&#39;foo[bar][baz]=foobarbaz&#39;</code>:</p>
<pre><code class="lang-javascript">assert.deepEqual(qs.parse(&#39;foo[bar][baz]=foobarbaz&#39;), {
    foo: {
        bar: {
            baz: &#39;foobarbaz&#39;
        }
...
<pre><code class="lang-javascript">var expected = {
    a: {
        b: {
            c: {
                d: {
...
<pre><code class="lang-javascript">var deep = qs.parse(&#39;a[b][c][d][e][f][g][h][i]=j&#39;, { depth: 1 });
...
<pre><code class="lang-javascript">var limited = qs.parse(&#39;a=b&amp;c=d&#39;, { parameterLimit: 1 });
assert.deepEqual(limited, { a: &#39;b&#39; });
</code></pre>
<p>To bypass the leading question mark, use <code>ignoreQueryPrefix</code>:</p>
<pre><code class="lang-javascript">var prefixed = qs.parse(&#39;?a=b&amp;c=d&#39;, { ignoreQueryPrefix: true });
assert.deepEqual(prefixed, { a: &#39;b&#39;, c: &#39;d&#39; });
</code></pre>
<p>An optional delimiter can also be passed:</p>
<pre><code class="lang-javascript">var delimited = qs.parse(&#39;a=b;c=d&#39;, { delimiter: &#39;;&#39; });
assert.deepEqual(delimited, { a: &#39;b&#39;, c: &#39;d&#39; });
</code></pre>
<p>Delimiters can be a regular expression too:</p>
<pre><code class="lang-javascript">var regexed = qs.parse(&#39;a=b;c=d,e=f&#39;, { delimiter: /[;,]/ });
assert.deepEqual(regexed, { a: &#39;b&#39;, c: &#39;d&#39;, e: &#39;f&#39; });
</code></pre>
<p>Option <code>allowDots</code> can be used to enable dot notation:</p>
<pre><code class="lang-javascript">var withDots = qs.parse(&#39;a.b=c&#39;, { allowDots: true });
...
<pre><code class="lang-javascript">var withArray = qs.parse(&#39;a[]=b&amp;a[]=c&#39;);
assert.deepEqual(withArray, { a: [&#39;b&#39;, &#39;c&#39;] });
</code></pre>
<p>You may specify an index as well:</p>
<pre><code class="lang-javascript">var withIndexes = qs.parse(&#39;a[1]=c&amp;a[0]=b&#39;);
...
their order:</p>
<pre><code class="lang-javascript">var noSparse = qs.parse(&#39;a[1]=b&amp;a[15]=c&#39;);
assert.deepEqual(noSparse, { a: [&#39;b&#39;, &#39;c&#39;] });
</code></pre>
<p>Note that an empty string is also a value, and will be preserved:</p>
<pre><code class="lang-javascript">var withEmptyString = qs.parse(&#39;a[]=&amp;a[]=b&#39;);
...
<pre><code class="lang-javascript">var encoded = qs.stringify({ a: { b: &#39;c&#39; } }, { encoder: function (str) {
...
<pre><code class="lang-javascript">var decoded = qs.parse(&#39;x=z&#39;, { decoder: function (str) {
...
<pre><code class="lang-javascript">qs.stringify({ a: [&#39;b&#39;, &#39;c&#39;, &#39;d&#39;] });
// &#39;a[0]=b&amp;a[1]=c&amp;a[2]=d&#39;
</code></pre>
<p>You may override this by setting the <code>indices</code> option to <code>false</code>:</p>
<pre><code class="lang-javascript">qs.stringify({ a: [&#39;b&#39;, &#39;c&#39;, &#39;d&#39;] }, { indices: false });
// &#39;a=b&amp;a=c&amp;a=d&#39;
</code></pre>
<p>You may use the <code>arrayFormat</code> option to specify the format of the output array:</p>
<pre><code class="lang-javascript">qs.stringify({ a: [&#39;b&#39;, &#39;c&#39;] }, { arrayFormat: &#39;indices&#39; })
// &#39;a[0]=b&amp;a[1]=c&#39;
...
<pre><code class="lang-javascript">assert.equal(qs.stringify({ a: null, b: undefined }), &#39;a=&#39;);
</code></pre>
<p>The query string may optionally be prepended with a question mark:</p>
<pre><code class="lang-javascript">assert.equal(qs.stringify({ a: &#39;b&#39;, c: &#39;d&#39; }, { addQueryPrefix: true }), &#39;?a=b&amp;c=d&#39;);
</code></pre>
<p>The delimiter may be overridden with stringify as well:</p>
<pre><code class="lang-javascript">assert.equal(qs.stringify({ a: &#39;b&#39;, c: &#39;d&#39; }, { delimiter: &#39;;&#39; }), &#39;a=b;c=d&#39;);
</code></pre>
...
<pre><code class="lang-javascript">var date = new Date(7);
...
<pre><code class="lang-javascript">function alphabeticalSort(a, b) {
...
<pre><code class="lang-javascript">function filterFunc(prefix, value) {
    if (prefix == &#39;b&#39;) {
...
<pre><code class="lang-javascript">var withNull = qs.stringify({ a: null, b: &#39;&#39; });
...
<pre><code class="lang-javascript">var equalsInsensitive = qs.parse(&#39;a&amp;b=&#39;);
...
<pre><code class="lang-javascript">var strictNull = qs.stringify({ a: null, b: &#39;&#39; }, { strictNullHandling: true });
assert.equal(strictNull, &#39;a&amp;b=&#39;);
</code></pre>
<p>To parse values without <code>=</code> back to <code>null</code> use the <code>strictNullHandling</code> flag:</p>
<pre><code class="lang-javascript">var parsedStrictNull = qs.parse(&#39;a&amp;b=&#39;, { strictNullHandling: true });
assert.deepEqual(parsedStrictNull, { a: null, b: &#39;&#39; });
</code></pre>
<p>To completely skip rendering keys with <code>null</code> values, use the <code>skipNulls</code> flag:</p>
<pre><code class="lang-javascript">var nullsSkipped = qs.stringify({ a: &#39;b&#39;, c: null}, { skipNulls: true });
...
<pre><code class="lang-javascript">var encoder = require(&#39;qs-iconv/encoder&#39;)(&#39;shift_jis&#39;);
var shiftJISEncoded = qs.stringify({ a: &#39;こんにちは！&#39; }, { encoder: encoder });
assert.equal(shiftJISEncoded, &#39;a=%82%B1%82%F1%82%C9%82%BF%82%CD%81I&#39;);
</code></pre>
<p>This also works for decoding of query strings:</p>
<pre><code class="lang-javascript">var decoder = require(&#39;qs-iconv/decoder&#39;)(&#39;shift_jis&#39;);
