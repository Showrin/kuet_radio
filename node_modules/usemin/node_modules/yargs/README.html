...
<p><a href="https://travis-ci.org/bcoe/yargs"><img src="https://travis-ci.org/bcoe/yargs.png" alt="Build Status"></a>
<a href="https://gemnasium.com/bcoe/yargs"><img src="https://gemnasium.com/bcoe/yargs.png" alt="Dependency Status"></a>
<a href="https://coveralls.io/r/bcoe/yargs?branch="><img src="https://coveralls.io/repos/bcoe/yargs/badge.svg?branch=" alt="Coverage Status"></a>
<a href="https://www.npmjs.com/package/yargs"><img src="https://img.shields.io/npm/v/yargs.svg" alt="NPM version"></a></p>
<blockquote>
...
<h2 id="but-don-t-walk-the-plank-just-yet-there-be-more-you-can-do-short-options-">But don&#39;t walk the plank just yet! There be more! You can do short options:</h2>
<p>short.js:</p>
<pre><code class="lang-javascript">#!/usr/bin/env node
var argv = require(&#39;yargs&#39;).argv;
...
(10,21)
</code></pre><h2 id="and-booleans-both-long-short-and-even-grouped-">And booleans, both long, short, and even grouped:</h2>
<p>bool.js:</p>
<pre><code class="lang-javascript">#!/usr/bin/env node
...
</code></pre><h2 id="and-non-hyphenated-options-too-just-use-argv-_-">And non-hyphenated options too! Just use <code>argv._</code>!</h2>
<p>nonopt.js:</p>
<pre><code class="lang-javascript">#!/usr/bin/env node
var argv = require(&#39;yargs&#39;).argv;
console.log(&#39;(%d,%d)&#39;, argv.x, argv.y);
...
(0.54,1.12)
[ &#39;me hearties&#39;, &#39;yo&#39;, &#39;ho&#39; ]
</code></pre><h2 id="yargs-even-counts-your-booleans-">Yargs even counts your booleans!</h2>
<p>count.js</p>
<pre><code class="lang-javascript">#!/usr/bin/env node
...
Showing semi-important stuff too
Extra chatty mode
</code></pre><h2 id="tell-users-how-to-use-yer-options-and-make-demands-">Tell users how to use yer options and make demands.</h2>
<p>area.js:</p>
<pre><code class="lang-javascript">#!/usr/bin/env node
var argv = require(&#39;yargs&#39;)
...
</code></pre><h2 id="after-yer-demands-have-been-met-demand-more-ask-for-non-hypenated-arguments-">After yer demands have been met, demand more! Ask for non-hypenated arguments!</h2>
<p>demand_count.js:</p>
<pre><code class="lang-javascript">#!/usr/bin/env node
var argv = require(&#39;yargs&#39;)
    .demand(2)
...
</code></pre><h2 id="even-more-shiver-me-timbers-">EVEN MORE SHIVER ME TIMBERS!</h2>
...
17
</code></pre><h2 id="and-if-you-really-want-to-get-all-descriptive-about-it-">And if you really want to get all descriptive about it...</h2>
...
[ true, false, true ]
[ &#39;one&#39;, &#39;two&#39;, &#39;three&#39; ]
</code></pre><h2 id="yargs-is-here-to-help-you-">Yargs is here to help you...</h2>
...
<p>By itself,</p>
<pre><code class="lang-javascript">require(&#39;yargs&#39;).argv
`
</code></pre>
...
<pre><code class="lang-javascript">require(&#39;yargs&#39;)([ &#39;-x&#39;, &#39;1&#39;, &#39;-y&#39;, &#39;2&#39; ]).argv
</code></pre>
<p>or use .parse() to do the same thing:</p>
<pre><code class="lang-javascript">require(&#39;yargs&#39;).parse([ &#39;-x&#39;, &#39;1&#39;, &#39;-y&#39;, &#39;2&#39; ])
</code></pre>
<p>The rest of these methods below come in just before the terminating <code>.argv</code>.</p>
<h2 id="-alias-key-alias-">.alias(key, alias)</h2>
<p>Set key names as equivalent such that updates to a key will propagate to aliases
and vice-versa.</p>
...
<h2 id="-default-key-value-description-">.default(key, value, [description])</h2>
...
<pre><code class="lang-js">var argv = require(&#39;yargs&#39;)
...
<pre><code class="lang-js">.default(&#39;timeout&#39;, 60000, &#39;(one-minute)&#39;);
</code></pre>
<h2 id="-demand-key-msg-boolean-">.demand(key, [msg | boolean])</h2>
<h2 id="-require-key-msg-boolean-">.require(key, [msg | boolean])</h2>
<h2 id="-required-key-msg-boolean-">.required(key, [msg | boolean])</h2>
...
<h2 id="-describe-key-desc-">.describe(key, desc)</h2>
...
<h2 id="-option-key-opt-">.option(key, opt)</h2>
<h2 id="-options-key-opt-">.options(key, opt)</h2>
<p>Instead of chaining together <code>.alias().demand().default().describe().string()</code>, you can specify
keys in <code>opt</code> for each of the chainable methods.</p>
<p>For example:</p>
<pre><code class="lang-javascript">var argv = require(&#39;yargs&#39;)
    .option(&#39;f&#39;, {
        alias : &#39;file&#39;,
        demand: true,
        default: &#39;/etc/passwd&#39;,
...
<h2 id="-usage-message-opts-">.usage(message, opts)</h2>
...
<h2 id="-command-cmd-desc-fn-">.command(cmd, desc, [fn])</h2>
...
values stored in <code>argv._</code>).</p>
<p>Optionally, you can provide a handler <code>fn</code> which will be executed when
a given command is provided. The handler will be executed with an instance
of <code>yargs</code>, which can be used to compose nested commands.</p>
...
<h2 id="-example-cmd-desc-">.example(cmd, desc)</h2>
...
<h2 id="-epilogue-str-">.epilogue(str)</h2>
<h2 id="-epilog-str-">.epilog(str)</h2>
<p>A message to print at the end of the usage instructions, e.g.,</p>
<pre><code class="lang-js">var argv = require(&#39;yargs&#39;)
  .epilogue(&#39;for more information, find our manual at http://example.com&#39;);
</code></pre>
<h2 id="-check-fn-">.check(fn)</h2>
...
<h2 id="-boolean-key-">.boolean(key)</h2>
...
<p><code>key</code> will default to <code>false</code>, unless an <code>default(key, undefined)</code> is
explicitly set.</p>
<p>If <code>key</code> is an Array, interpret all the elements as booleans.</p>
<h2 id="-string-key-">.string(key)</h2>
...
<h2 id="-array-key-">.array(key)</h2>
<p>Tell the parser to interpret <code>key</code> as an array. If <code>.array(&#39;foo&#39;)</code> is set,
<code>--foo foo bar</code> will be parsed as <code>[&#39;foo&#39;, &#39;bar&#39;]</code> rather than as <code>&#39;bar&#39;</code>.</p>
<h2 id="-nargs-key-count-">.nargs(key, count)</h2>
<p>The number of arguments that should be consumed after a key. This can be a
useful hint to prevent parsing ambiguity:</p>
<pre><code class="lang-js">var argv = require(&#39;yargs&#39;)
  .nargs(&#39;token&#39;, 1)
...
<h2 id="-config-key-">.config(key)</h2>
...
<h2 id="-wrap-columns-">.wrap(columns)</h2>
...
specify no column limit.</p>
<p><code>yargs.wrap(yargs.terminalWidth())</code> can be used to maximize the width
of yargs&#39; usage instructions.</p>
...
<h2 id="-help-option-description-">.help([option, [description]])</h2>
<p>Add an option (e.g., <code>--help</code>) that displays the usage string and exits the
process. If present, the <code>description</code> parameter customises the description of
...
<h2 id="-version-version-option-description-">.version(version, [option], [description])</h2>
<p>Add an option (e.g., <code>--version</code>) that displays the version number (given by the
<code>version</code> parameter) and exits the process. If present, the <code>description</code>
parameter customizes the description of the version option in the usage string.</p>
<p>You can provide a <code>function</code> for version, rather than a string.
This is useful if you want to use the version from your package.json:</p>
<pre><code class="lang-js">var argv = require(&#39;yargs&#39;)
  .version(function() {
...
<h2 id="-showhelponfail-enable-message-">.showHelpOnFail(enable, [message])</h2>
<p>By default, yargs outputs a usage string if any error is detected. Use the
<code>.showHelpOnFail</code> method to customize this behaviour. if <code>enable</code> is <code>false</code>,
...
</code></pre><h2 id="-showhelp-consolelevel-error-">.showHelp(consoleLevel=&#39;error&#39;)</h2>
...
<pre><code>var yargs = require(&quot;yargs&quot;)
       .usage(&quot;$0 -operand1 number -operand2 number -operation [add|subtract]&quot;);
yargs.showHelp();
</code></pre><p>Or, to print the usage data to <code>stdout</code> instead, you can specify the use of <code>console.log</code>:</p>
<pre><code>yargs.showHelp(&quot;log&quot;);
</code></pre><p>Later on, <code>argv</code> can be retrived with <code>yargs.argv</code></p>
<h2 id="-completion-cmd-description-fn-">.completion(cmd, [description], [fn]);</h2>
...
<p><code>fn</code>, rather than relying on yargs&#39; default completion functionlity, which
...
<h2 id="-exitprocess-enable-">.exitProcess(enable)</h2>
...
creating nested command line interfaces.</p>
<pre><code class="lang-js">var yargs = require(&#39;./yargs&#39;)
  .usage(&#39;$0 command&#39;)
...
{ _: [ &#39;-c&#39;, &#39;3&#39;, &#39;-d&#39;, &#39;4&#39; ],
  ...
  a: 1,
  b: 2 }
</code></pre><h2 id="negate-fields">negate fields</h2>
<p>If you want to explicity set a field to false instead of just leaving it
...
{ _: [],
  ...
  a: true,
  b: false }
</code></pre><h2 id="numbers">numbers</h2>
...
</code></pre><h2 id="short-numbers">short numbers</h2>
...
<pre><code>git clone http://github.com/bcoe/yargs.git
</code></pre><p>To run the tests with npm, just do:</p>
<pre><code>npm test
</code></pre><h1 id="inspired-by">inspired by</h1>
