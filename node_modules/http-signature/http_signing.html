...
</code></pre><h3 id="signature-parameters">Signature Parameters</h3>
...
Content-Length: 18
</code></pre><p>The &quot;rsa-key-1&quot; keyId refers to a private key known to the client and a public
...
</code></pre><h2 id="header-list">Header List</h2>
<p>The authorization header and signature would be generated as:</p>
...
</code></pre><h2 id="algorithm">Algorithm</h2>
<p>The authorization header and signature would be generated as:</p>
...
</code></pre><h1 id="signing-algorithms">Signing Algorithms</h1>
...
</code></pre><h1 id="appendix-a-test-values">Appendix A - Test Values</h1>
...
<h2 id="generating-and-verifying-signatures-using-openssl">Generating and verifying signatures using <code>openssl</code></h2>
...
$
</code></pre><p>The <code>-sha256</code> option is necessary to produce an <code>rsa-sha256</code> signature. You can select other hash algorithms such as <code>sha1</code> by changing this argument.</p>
...
Verified OK
$
</code></pre><h2 id="generating-and-verifying-signatures-using-sshpk-sign">Generating and verifying signatures using <code>sshpk-sign</code></h2>
...
jKyvPcxB4JbmYY4mByyBY7cZfNl4OW9Hp...
$
</code></pre><p>This will produce an <code>rsa-sha256</code> signature by default, as you can see using
the <code>-v</code> option:</p>
<pre><code>sshpk-sign: using rsa-sha256 with a 1024 bit key
</code></pre><p>You can also use <code>sshpk-verify</code> in a similar manner:</p>
<pre><code>$ printf &#39;date: Thu, 05 Jan 2014 21:31:40 GMT&#39; | \
